import sys
sys.path.insert(0,'/content/drive/My Drive/Ramzi_architecture/fastmri-reproducible-benchmark/') 
...
test_path = f'{FASTMRI_DATA_DIR}singlecoil_test_v2/'
...
def train_pdnet(subclassed, af, contrast, cuda_visible_devices, n_samples, n_epochs, n_iter):
    ...
    chkpt_cback = ModelCheckpoint(chkpt_path, period=1, save_weights_only=True)
