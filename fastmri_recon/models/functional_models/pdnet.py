...
from ..utils.complex_complex import conv2d_complex
...
def pdnet(input_size=(640, None, 1), n_filters=32, lr=1e-3, n_primal=5, n_dual=5, n_iter=10, primal_only=False, fastmri=True, activation='relu'):
    ...
    """
    # shapes
    print("entered model.fit training")
    mask_shape = input_size[:-1]
    # print(mask_shape,"dfgfghfghfhfghfghfghfghhf")
    ...
    print("INputttttttttt sizeeeeeeeeeeeeeeeee")
    print(input_size)
